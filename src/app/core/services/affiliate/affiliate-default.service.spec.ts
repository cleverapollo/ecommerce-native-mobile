...
describe('AffiliateDefaultService', () => {
  ...
  describe('createAffiliateLink', () => {
    ...
    it('should create affiliate links correctly', (done) => {
      ...
      link = 'https://www.otto.de/p/taschenfederkernmatratze-senioren-55-plus-delavita-24-cm-hoch-420-federn-mit-sitzkantenverstaerkung-getestete-qualitaet-mit-4-5-sterne-bewertung-448251235/#variationId=448251326';
      ...
      link = 'https://www.pearlco.de/wasserfilter-astra-unimax_9';
      ...
      link = 'https://www.nordicnest.de/marken/kay-bojesen-denmark/kay-bojesen-affe-klein/?variantId=6322-01';
      ...
      link = 'https://www.vertbaudet.de/jungen-langarmshirt-mit-grafischem-motiv-blau-wei.htm?ProductId=700260955&FiltreCouleur=6400&t=1';
      ...
      link = 'https://aromamanufaktur.com/collections/geschenkideen/products/winter-set-5x10ml-duft-geschenkset-atherische-winter-ole-im-set';
      ...
      link = 'https://hempamed.de/collections/cbd-mundspray/products/hempamed-cbd-mundspray-natur-5';
      ...
      link = 'https://www.klaraseats.com/KAB-554-24V-Stoff-Havanna-schwarz-Heizung-Armlehnen-Kopfstuetze';

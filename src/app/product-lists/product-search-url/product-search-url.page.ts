...
@Component({
  selector: 'app-product-search-url',
  templateUrl: './product-search-url.page.html',
  styleUrls: ['./product-search-url.page.scss'],
})
export class ProductSearchUrlPage implements OnInit, OnDestroy {
